...
<!-- * Title Section -->
  <h3 align="center">Cocopan</h3>
</div>

<!-- * Description Section -->
<div align="center">
Cocopan serves as an online platform that promotes and represents the Cocopan brand, a bakery and coffee shop known for offering freshly baked bread, pastries, and brewed coffee 24/7. It aims to introduce the brand to customers, highlight its signature products, and showcase what makes Cocopan unique—its commitment to providing comfort, quality, and affordability at any time of the day. The website also serves as a convenient way for customers to explore the menu, learn more about the business, and stay connected with the brand. Additionally, features such as the “Login” and “Sign Up” buttons prepare the website for future enhancements, such as online ordering, personalized accounts, or customer engagement activities, making it a complete digital extension of Cocopan’s physical store experience.
</div>
